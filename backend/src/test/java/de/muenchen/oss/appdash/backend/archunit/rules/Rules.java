package de.muenchen.oss.appdash.backend.archunit.rules;

import static com.tngtech.archunit.lang.syntax.ArchRuleDefinition.methods;
import static de.muenchen.oss.appdash.backend.archunit.rules.TestClassesEndWithTestCondition.haveTopEnclosingClassEndingWithTest;
...
public final class Rules {
  ...
  public static final ArchRule RULE_TEST_NAMING_CONVENTION_GIVEN_THEN_MATCHED =
      methods()
          .that()
          ...
          .should()
          .haveNameMatching("^given[A-Z][a-zA-Z]+_then[A-Z][a-zA-Z]+$")
