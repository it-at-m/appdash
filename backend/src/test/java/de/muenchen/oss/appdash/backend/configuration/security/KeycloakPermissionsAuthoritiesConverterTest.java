...
import static de.muenchen.oss.appdash.backend.TestConstants.SPRING_TEST_PROFILE;
import static de.muenchen.oss.appdash.backend.configuration.security.KeycloakPermissionsAuthoritiesConverter.PERMISSION_LIST;
...
class KeycloakPermissionsAuthoritiesConverterTest {
  ...
  void givenCacheHit_thenConvert() {
    ...
    final Collection<GrantedAuthority> cachedAuthorities =
