package de.muenchen.oss.appdash.backend.archunit;

import com.tngtech.archunit.core.domain.JavaClasses;
import com.tngtech.archunit.core.importer.ClassFileImporter;
import com.tngtech.archunit.core.importer.ImportOption;
import com.tngtech.archunit.lang.ArchRule;
import de.muenchen.oss.appdash.backend.AppDashApplication;
import de.muenchen.oss.appdash.backend.archunit.rules.Rules;
...
public class ArchUnitTest {
  ...
  static void init() {
    allTestClasses =
        new ClassFileImporter()
            ...
            .importPackages(AppDashApplication.class.getPackage().getName());
  }
  ...
  public static Stream<Arguments> allTestClassesRulesToVerify() {
    return Stream.of(
        ...
        Arguments.of(
            "Test methods must follow 'given_then' naming convention",
            Rules.RULE_TEST_NAMING_CONVENTION_GIVEN_THEN_MATCHED),
        Arguments.of(
            "BeforeEach methods must follow naming convention",
            Rules.RULE_BEFORE_EACH_NAMING_CONVENTION_MATCHED),
        Arguments.of(
            "AfterEach methods must follow naming convention",
  ...
  void givenAllArchUnitRulesForAllTestClasses_thenRunArchUnitTests(
