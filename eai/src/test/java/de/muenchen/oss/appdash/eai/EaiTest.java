...
/**
 * The test is used to demonstrate how any test configuration (test/application-test.yml) to test
 * the entire EAI can be tested from start to shut down with one test call.
 */
@SpringBootTest
@CamelSpringBootTest
